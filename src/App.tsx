        ...
        <CartProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/services/youtube" element={<ServicePage />} />
              <Route path="/services/instagram" element={<ServicePage />} />
              <Route path="/services/facebook" element={<ServicePage />} />
              <Route path="/services/twitter" element={<ServicePage />} />
              <Route path="/services/linkedin" element={<ServicePage />} />
              <Route path="/services/google-reviews" element={<ServicePage />} />
              <Route path="/services/trustpilot" element={<ServicePage />} />
